# Chaos Experiments
This repository has 3 scripts that help in performing 3 different chaos experiments.
...
* These scripts will be executed on the VMs running CentOS 8.
* A user with sudo access exists and will be used to run some of these scripts.
